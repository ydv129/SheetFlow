...
export const ExcelDataViewer = memo(function ExcelDataViewer({
  ...
  const [localSheetIndex, setLocalSheetIndex] = useState(
  ...
  if (!selectedSheet) {
    return <div className="p-4 text-center text-red-500">Sheet not found</div>;
  }
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="p-3 bg-green-50 rounded">
          ...
          <p className="text-2xl font-bold text-green-600">
            {selectedSheet.columnNames.length}
          </p>
        </div>
